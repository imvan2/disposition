      ...
      <div className="container-fluid">
        <NavLink className="navbar-brand" to="/">
          <img
            ...
            src={require("./images/Disp_Logo_LG_LT.png")}
          />
        </NavLink>
        <button
        ...
        >
          <div className="offcanvas-header bg-secondary text-white">
            <h5 className="offcanvas-title" id="offcanvasWithBothOptionsLabel">
              <img
                height="50px"
                alt="Disposition logo"
                src={require("./images/Disp_Disk_LT.png")}
              />{" "}
              Menu
            </h5>
          ...
          <div className="offcanvas-body bg-success p-3 mb-2 bg-dark text-white">
            <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li>
                <NavLink className="nav-link ms-3" to="/Vibecheck">
                  Vibe Check
                </NavLink>
              </li>
              {!loggedIn ? (
                ...
                <li>
                  <NavLink className="nav-link ms-3" to="/Logout">
                    Logout
                  </NavLink>
                </li>
              )}
              {!loggedIn && (
                <li>
                  <NavLink className="nav-link ms-3" to="/SignupForm">
                    Sign-up
                  </NavLink>
                </li>
              )}
              {loggedIn ? (
                <li>
                  <NavLink className="nav-link ms-3" to="/History">
                    History
                  </NavLink>
                </li>
              ) : (
